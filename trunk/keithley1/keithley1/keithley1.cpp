...
BEGIN_MESSAGE_MAP(Ckeithley1App, CWinApp)
...
// 唯一的一个 Ckeithley1App 对象

Ckeithley1App theApp;

const GUID CDECL BASED_CODE _tlid =
		{ 0x6ED50F2A, 0x1138, 0x496D, { 0xBE, 0x4C, 0x55, 0x94, 0x3E, 0xF3, 0xA3, 0x7F } };
